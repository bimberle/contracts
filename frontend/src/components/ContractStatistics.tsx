    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="text-sm text-gray-600 mt-2">∅ {formatCurrency(stats.avgRevenue)} pro Monat</div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="text-sm text-gray-600 mt-2">∅ {formatCurrency(stats.avgCommission)} pro Monat</div>
        </div>
      </div>
